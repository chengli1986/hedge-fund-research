...
_FUND_PROFILES: dict[str, dict] = {
    ...
    "msci-research": {
        ...
        "desc_zh": "全球领先的指数、ESG/气候分析与因子模型提供商，1969 年由 Capital International 创立，2007 年从 Morgan Stanley 分拆独立上市。核心业务覆盖：ACWI/EAFE/新兴市场基准指数（全球约 $15T 资金跟踪）、Quality/Value/Momentum 等因子指数、ESG 与气候评级、多资产风险模型与指数构建方法论。",
    ...
    "ares-management": {
        "founded": "1997", "aum": "~$484B", "hq": "Los Angeles, USA",

...
D1 — analyze_articles._call_gemini indexed data["candidates"][0] unguarded
     (safety-filtered replies carry an empty list). Fixed 2026-09-19; the
     Gemini tier and its caller were removed 2026-09-21, and D1's tests went
     with them. Kept here so the numbering in the audit log still resolves.

...
| **MetLife Investment Management** | SSR (sitemap + requests) | Weekly | Public fixed income, private credit, real estate, agricultural finance, multi-asset macro; absorbed PineBridge's research teams after completing the acquisition 30 Dec 2025 (replaced the `pinebridge` source on 7-27); Whippany NJ, ~$700B |
